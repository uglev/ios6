...
Итак, что он может. Вы заходите на свой сайт - например http://yoursite.com (http!), и читаете все свежие новости с почты и Телеграмма и даже отвечаете на них! А если не отвечаете, а просто пишите в поле, тогда сообщение сразу отправляется в папку "Избранное" Телеграмма.
