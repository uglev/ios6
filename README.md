...
Итак, что он может. Вы заходите на свой сайт, и читаете все свежие новости с почты и Телеграмма и даже отвечаете на них! А если не отвечаете, тогда сообщение сразу отправляется в папку "Избранное" Телеграмма.
